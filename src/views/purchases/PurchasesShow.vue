      ...
      <div class="row">
        <div class="col mb-3">
          ...
          <p>
            ...
            <span
              class="badge bg-success mx-1 text-capitalize"
              :class="
                ({ 'bg-success': purchase.payment_status === 'paid' },
                { 'bg-warning': purchase.payment_status === 'due' })
              "
        ...
        <div class="col">
          <div class="mb-3">
            <p>
              <b>Purchase Date:</b>
              {{ moment(purchase.date).format("DD MMMM YYYY") }}
            </p>
          </div>
        </div>
        <div class="col">
            ...
            >
              ...
              <td>
                <router-link
                  :to="{
                    name: 'products.show',
                    params: { id: purchaseDetail.product.id },
                  }"
                >
